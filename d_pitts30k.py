...
"""
Pitts30k dataset from Pittsburgh.
in pose.txt ci sono le pose delle query
"""
import os
import re
import utm
...
for filename in ["000.tar", "001.tar", "002.tar", "003.tar", "004.tar", "005.tar",
                 "006.tar", "groundtruth.tar", "netvlad_v100_datasets.tar.gz",
...
for dataset in ["train", "val", "test"]:
    matlab_struct_file_path = f"{dataset_folder}/raw_data/datasets/pitts30k_{dataset}.mat"
